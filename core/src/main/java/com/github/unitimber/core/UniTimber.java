...
/**
 * Based on Timber 4.5.1 by Jake Wharton.
 *
 * Removed tight coupling with android.util.Log class
 * - now calls are delegated to the instance of AbstractLogger subclass.
 * (AndroidLogger is used by default to minimize client changes when switching from Timber)
 */
public final class UniTimber {
    ...
    /**
     * A view into UniTimber's planted trees as a tree itself. This can be used for injecting a logger
    ...
    public static void plant(Tree tree) {
        ...
        if (tree == TREE_OF_SOULS) {
            throw new IllegalArgumentException("Cannot plant UniTimber into itself.");
        }
        synchronized (FOREST) {
            FOREST.add(tree);
    ...
    /** A facade for handling logging calls. Install instances via {@link #plant UniTimber.plant()}. */
    public static abstract class Tree {
        ...
        public void v(String message, Object... args) {
            prepareLog(logger.getVERBOSE(), null, message, args);
        }

        /** Log a verbose exception and a message with optional format args. */
        public void v(Throwable t, String message, Object... args) {
            prepareLog(logger.getVERBOSE(), t, message, args);
        }

        /** Log a verbose exception. */
        public void v(Throwable t) {
            prepareLog(logger.getVERBOSE(), t, null);
        }

        /** Log a debug message with optional format args. */
        public void d(String message, Object... args) {
            prepareLog(logger.getDEBUG(), null, message, args);
        }

        /** Log a debug exception and a message with optional format args. */
        public void d(Throwable t, String message, Object... args) {
            prepareLog(logger.getDEBUG(), t, message, args);
        }

        /** Log a debug exception. */
        public void d(Throwable t) {
            prepareLog(logger.getDEBUG(), t, null);
        }

        /** Log an info message with optional format args. */
        public void i(String message, Object... args) {
            prepareLog(logger.getINFO(), null, message, args);
        }

        /** Log an info exception and a message with optional format args. */
        public void i(Throwable t, String message, Object... args) {
            prepareLog(logger.getINFO(), t, message, args);
        }

        /** Log an info exception. */
        public void i(Throwable t) {
            prepareLog(logger.getINFO(), t, null);
        }

        /** Log a warning message with optional format args. */
        public void w(String message, Object... args) {
            prepareLog(logger.getWARN(), null, message, args);
        }

        /** Log a warning exception and a message with optional format args. */
        public void w(Throwable t, String message, Object... args) {
            prepareLog(logger.getWARN(), t, message, args);
        }

        /** Log a warning exception. */
        public void w(Throwable t) {
            prepareLog(logger.getWARN(), t, null);
        }

        /** Log an error message with optional format args. */
        public void e(String message, Object... args) {
            prepareLog(logger.getERROR(), null, message, args);
        }

        /** Log an error exception and a message with optional format args. */
        public void e(Throwable t, String message, Object... args) {
            prepareLog(logger.getERROR(), t, message, args);
        }

        /** Log an error exception. */
        public void e(Throwable t) {
            prepareLog(logger.getERROR(), t, null);
        }

        /** Log an assert message with optional format args. */
        public void wtf(String message, Object... args) {
            prepareLog(logger.getASSERT(), null, message, args);
        }

        /** Log an assert exception and a message with optional format args. */
        public void wtf(Throwable t, String message, Object... args) {
            prepareLog(logger.getASSERT(), t, message, args);
        }

        /** Log an assert exception. */
        public void wtf(Throwable t) {
            prepareLog(logger.getASSERT(), t, null);
        }
    ...
    public static class DebugTree extends Tree {
        ...
        public DebugTree(AbstractLogger logger) {
            super(logger) ;
        }
         ...
         * {@link Log#println(int, String, String) logger.println()} or
         * {@link Log#wtf(String, String) logger.wtf()} for logging.
         *
         * {@inheritDoc}
         */
        @Override protected void log(int priority, String tag, String message, Throwable t) {
            if (message.length() < MAX_LOG_LENGTH) {
                if (priority == logger.getASSERT()) {
                    logger.wtf(tag, message);
                } else {
                    logger.println(priority, tag, message);
                }
                return;
            }
            ...
            for (int i = 0, length = message.length(); i < length; i++) {
                ...
                do {
                    ...
                    if (priority == logger.getASSERT()) {
                        ...
                        logger.println(priority, tag, part);
                    }
                    i = end;
                } while (i < newline);
            }
